...
const V128CONST_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x00, // 0 locals
    0xfd, 0x0c, // v128.const sub-opcode
...
const ADD_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x20, 0x00,
    0x20, 0x01,
    0xfd, 0xae, 0x01, // i32x4.add (sub=174=0xAE, LEB128: 0xAE 0x01)
    0x0b,
  ),
);
...
const EXTRACT_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x00,
    0x20, 0x00,
    0xfd, 0x15, 0x03, // i8x16.extract_lane_s, lane=3
    0x0b,
  ),
);
...
const REPLACE_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x20, 0x00,
    0x20, 0x01,
    0xfd, 0x1c, 0x02, // i32x4.replace_lane, lane=2
    0x0b,
  ),
);
...
const SHIFT_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x20, 0x00,
    0x20, 0x01,
    0xfd, 0xab, 0x01, // i32x4.shl (sub=171)
    0x0b,
  ),
);
...
const BITSELECT_MODULE = module(
  ...
  section(0x0a, 0x01,
    ...
    0x20, 0x01,
    0x20, 0x02,
    0xfd, 0x52, // v128.bitselect (sub=0x52)
    0x0b,
  ),
);
