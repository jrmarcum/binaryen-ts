...
| [testing.md](testing.md)           | How to run `deno task check` / `test` / `ci`; the Deno-only test suite (367 passing, 1 ignored as of 2026-07-05; +7 S1 +10 S2 asyncify +9 flatten); the seeded differential optimizer fuzzer (`optimize_fuzz_test.ts`) and why behavioral fuzzing exists                                                                                                                  |
